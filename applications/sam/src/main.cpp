...
int main( int argc, char** argv )
{
	try
	{
		...
		tuttle::host::ofx::imageEffect::OfxhImageEffectPlugin* pluginW = tuttle::host::core::Core::instance().getImageEffectPluginById( "fr.hd3d.tuttle.exrwriter" );
