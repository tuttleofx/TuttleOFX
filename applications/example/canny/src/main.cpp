...
//		Graph::Node& bitdepth    = g.createNode( "tuttle.bitdepth" );
		...
		Graph::Node& sobel        = g.createNode( "tuttle.duranduboi.sobel" );
		Graph::Node& sobel1       = g.createNode( "tuttle.duranduboi.sobel" );
		Graph::Node& sobel2       = g.createNode( "tuttle.duranduboi.sobel" );
		Graph::Node& localMaxima  = g.createNode( "tuttle.duranduboi.localmaxima" );
		Graph::Node& floodfill    = g.createNode( "tuttle.duranduboi.floodfill" );
		Graph::Node& thinning     = g.createNode( "tuttle.duranduboi.thinning" );
