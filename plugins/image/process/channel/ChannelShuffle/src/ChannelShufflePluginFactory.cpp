 ...
 */
void ChannelShufflePluginFactory::describeInContext( OFX::ImageEffectDescriptor& desc,
 ...
 */
OFX::ImageEffect* ChannelShufflePluginFactory::createInstance( OfxImageEffectHandle handle,
                                                            OFX::EContext context )
{
