...
void MathOperatorProcess<View>::multiThreadProcessImages( const OfxRectI& procWindowRoW )
{
	...
	switch(params.op)
	{
		case eMathOperatorOperatorPlus     : processImagePlus      ( procWindowOutput, procWindowRoW, valuesPix, processChannel ); break;
		case eMathOperatorOperatorMultiply : processImageMultiply  ( procWindowOutput, procWindowRoW, valuesPix, processChannel ); break;
		case eMathOperatorOperatorPow      : processImagePow       ( procWindowOutput, procWindowRoW, valuesPix, processChannel ); break;
		case eMathOperatorOperatorSqrt     : processImageSqrt      ( procWindowOutput, procWindowRoW, valuesPix, processChannel ); break;
		case eMathOperatorOperatorLog      : processImageLog       ( procWindowOutput, procWindowRoW, valuesPix, processChannel ); break;
		case eMathOperatorOperatorLn       : processImageLn        ( procWindowOutput, procWindowRoW, valuesPix, processChannel ); break;
	}
