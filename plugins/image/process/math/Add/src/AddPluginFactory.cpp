 ...
 */
void AddPluginFactory::describeInContext( OFX::ImageEffectDescriptor& desc,
                                                  OFX::EContext context )
{
	...
	OFX::ChoiceParamDescriptor* addType = desc.defineChoiceParam( kAddType );
	addType->setLabel( "Type" );
	addType->setHint( "Gamma selection mode." );
	addType->appendOption( kAddGlobal );
	addType->appendOption( kAddChannels );
 ...
 */
OFX::ImageEffect* AddPluginFactory::createInstance( OfxImageEffectHandle handle,
                                                            OFX::EContext context )
{
