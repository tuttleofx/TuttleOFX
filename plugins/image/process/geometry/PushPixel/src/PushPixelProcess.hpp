...
public:
    ...
    void preProcess() { this->progressBegin( (this->_renderArgs.renderWindow.y2 - this->_renderArgs.renderWindow.y1) * (this->_renderArgs.renderWindow.x2 - this->_renderArgs.renderWindow.x1) * 4 ); }
