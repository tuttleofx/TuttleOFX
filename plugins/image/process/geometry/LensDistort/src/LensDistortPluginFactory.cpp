...
{
    desc.setLabels("TuttleLensDistort", "LensDistort", "Create or correct lens distortion.");
...
void LensDistortPluginFactory::describeInContext(OFX::ImageEffectDescriptor& desc, OFX::EContext context)
{
    ...
    displaySource->setHint(
        "Display the image source (useful to parameter the distortion with lines overlays on the source image).");
    ...
    focal->setHint("Focal value to scale the interpretation "
    ...
    preScale->setHint("If the transformation of optics is high, you may need to change the scale of the result to be "
                      "globally closer to the source image or preserve a good resolution.");
    ...
    postScale->setHint("If the transformation of optics is high, you may need to change the scale of the result to be "
                       "globally closer to the source image or preserve a good resolution.");
