...
void FloodFillPluginFactory::describe(OFX::ImageEffectDescriptor& desc)
{
    ...
    desc.setDescription(
        ...
        "\n"
        "It is used in the 'bucket' fill tool of paint programs to fill connected, similarly-colored areas with a different "
        "color. \n"
 ...
 */
void FloodFillPluginFactory::describeInContext(OFX::ImageEffectDescriptor& desc, OFX::EContext context)
{
 ...
 */
OFX::ImageEffect* FloodFillPluginFactory::createInstance(OfxImageEffectHandle handle, OFX::EContext context)
{
