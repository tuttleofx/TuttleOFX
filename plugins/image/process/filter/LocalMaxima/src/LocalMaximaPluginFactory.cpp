 ...
 */
void LocalMaximaPluginFactory::describeInContext(OFX::ImageEffectDescriptor& desc, OFX::EContext context)
{
    ...
    outputComponent->appendOption(OFX::getImageEffectHostDescription()->supportsPixelComponent(OFX::ePixelComponentRGB)
                                      ...
                                      : "---");
    outputComponent->appendOption(OFX::getImageEffectHostDescription()->supportsPixelComponent(OFX::ePixelComponentAlpha)
 ...
 */
OFX::ImageEffect* LocalMaximaPluginFactory::createInstance(OfxImageEffectHandle handle, OFX::EContext context)
{
