 ...
 */
void ColorSuppressPluginFactory::describeInContext( OFX::ImageEffectDescriptor& desc,
 ...
 */
OFX::ImageEffect* ColorSuppressPluginFactory::createInstance( OfxImageEffectHandle handle,
                                                            OFX::EContext context )
{
