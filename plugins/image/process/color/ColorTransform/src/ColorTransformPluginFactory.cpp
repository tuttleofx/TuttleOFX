 ...
 */
void ColorTransformPluginFactory::describeInContext(OFX::ImageEffectDescriptor& desc, OFX::EContext context)
{
 ...
 */
OFX::ImageEffect* ColorTransformPluginFactory::createInstance(OfxImageEffectHandle handle, OFX::EContext context)
{
