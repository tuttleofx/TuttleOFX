      ...
      namespace colorspace
      {
        ...
        OCIOColorSpacePlugin::render(const OFX::RenderArguments& args)
        {
          ...
          case OFX::ePixelComponentRGBA:
            {
              ...
              case OFX::eBitDepthFloat:
                {
                  doGilRender<OCIOColorSpaceProcess, false, rgba_layout_t,
                      bits32f>(*this, args);
                  return;
                }
              ...
              case OFX::eBitDepthNone:
                {
                  BOOST_THROW_EXCEPTION(
                      exception::Unsupported() << exception::user() + "Bit depth (" + mapBitDepthEnumToString(bitDepth) + ") not recognized by the plugin.");
                }
                }
              break;
            }
          case OFX::ePixelComponentRGB:
            {
              ...
              case OFX::eBitDepthFloat:
                {
                  doGilRender<OCIOColorSpaceProcess, false, rgb_layout_t,
                      bits32f>(*this, args);
                  return;
                }
              case OFX::eBitDepthUByte:
          ...
          case OFX::ePixelComponentNone:
            {
              BOOST_THROW_EXCEPTION(
                  exception::Unsupported() << exception::user() + "Pixel components (" + mapPixelComponentEnumToString(components) + ") not supported by the plugin.");
            }
            }
        ...
        OCIOColorSpacePlugin::getProcessParams(
