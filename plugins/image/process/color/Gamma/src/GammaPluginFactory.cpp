 ...
 */
void GammaPluginFactory::describeInContext(OFX::ImageEffectDescriptor& desc, OFX::EContext context)
{
 ...
 */
OFX::ImageEffect* GammaPluginFactory::createInstance(OfxImageEffectHandle handle, OFX::EContext context)
{
