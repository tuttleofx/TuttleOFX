#ifndef COLORCUBEOVERLAY_HPP
#define	COLORCUBEOVERLAY_HPP
...
class ColorCubeOverlay:public OFX::OverlayInteract
{
public:
	/*Class arguments*/
	ColorCubePlugin* _plugin;				//plugin reference
...
public:
	...
	ColorCubeOverlay(OfxInteractHandle handle,OFX::ImageEffect* effect);
	virtual ~ColorCubeOverlay();
...
class ColorCubeOverlayDescriptor : public OFX::EffectOverlayDescriptor
{
public:
	OFX::Interact* createInstance( OfxInteractHandle handle, OFX::ImageEffect* effect )
	{
		return new ColorCubeOverlay( handle, effect );
	}
};
