 ...
 */
class ColorCubePlugin : public ImageEffectGilPlugin
{
public:
...
public:
	...
	ColorCubeProcessParams<Scalar> getProcessParams( const OfxPointD& renderScale = OFX::kNoRenderScale ) const;
