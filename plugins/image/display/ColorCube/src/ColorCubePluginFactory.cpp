...
{
	//describe the plugin
	desc.setLabels( "TuttleColorCube", "ColorCube",
		            "ColorCube" );
	desc.setPluginGrouping( "tuttle/image/process/color" );

	desc.setDescription( "ColorCube\n"
	                     "Plugin is used to ???." );
...
//	desc.setRenderThreadSafety( OFX::eRenderFullySafe );
	...
	//Overlay class
	desc.setOverlayInteractDescriptor( new OFX::DefaultEffectOverlayWrap<ColorCubeOverlayDescriptor>() );
}
