#ifndef _TUTTLE_PLUGIN_DIFFPLOT_DEFINITIONS_HPP_
#define _TUTTLE_PLUGIN_DIFFPLOT_DEFINITIONS_HPP_
...
const static std::string kGroupDiffPlotOverlay = "HOverlay";
const static std::string kGroupDiffPlotOverlayLabel = "DiffPlot overlay";
...
//DiffPlots color (struct)
struct DiffPlotColor
{
...
static const DiffPlotColor redHisto = {redBorder,redFilling};
static const DiffPlotColor greenHisto = {greenBorder,greenFilling};
static const DiffPlotColor blueHisto = {blueBorder,blueFilling};

//Average bar color
static const OfxRGBColourF averageFilling={0.2f,0.2f,1.0f};
static const OfxRGBColourF averageBorder={1.0f,0.84f,0.0f};
static const DiffPlotColor averageHisto = {averageBorder,averageFilling};
