...
DiffPlotOverlay::DiffPlotOverlay(OfxInteractHandle handle,OFX::ImageEffect* effect)
...
DiffPlotOverlay::~DiffPlotOverlay()
{
	_plugin->releaseOverlayData();	//release Overlay data
}

bool DiffPlotOverlay::draw( const OFX::DrawArgs& args )
{	
		...
		)
	{
		...
		if( ! _plugin->getIsRendering() )
		{
			...
			getOverlayData().computeFullData( _plugin->_clipSrc, _plugin->_clipSrcB, args.time, args.renderScale );
		}
 ...
 */
bool DiffPlotOverlay::penMotion( const OFX::PenArgs& args )
{
 ...
 * @return event capted (y or n)
 */
bool DiffPlotOverlay::penDown( const OFX::PenArgs& args )
{
 ...
 * @return event capted (y or n)
 */
bool DiffPlotOverlay::penUp( const OFX::PenArgs& args )
{
 ...
 * @return event capted (y or n)
 */
bool DiffPlotOverlay::keyDown( const OFX::KeyArgs& args )
{
 ...
 * @return event capted (y or n)
 */
bool DiffPlotOverlay::keyUp( const OFX::KeyArgs& args )
{
 ...
 */
void DiffPlotOverlay::displaySelectedAreas( const OfxPointI& fullImgSize, const OfxPointI& imgSize, const OfxRectI& pixelRoD )
{
 ...
 */
void DiffPlotOverlay::displaySelectionZone()
{
	glEnable(GL_BLEND);
 ...
 */
void DiffPlotOverlay::drawWarning(const Ofx3DPointD& centerPoint, const double ratio)
{
 ...
 * @return 
 */
OverlayData& DiffPlotOverlay::getOverlayData()
{
