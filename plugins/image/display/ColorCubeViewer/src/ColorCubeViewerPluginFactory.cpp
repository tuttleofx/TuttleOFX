...
{
	//describe the plugin
	desc.setLabels( "TuttleColorCubeViewer", "ColorCubeViewer",
		            "ColorCubeViewer" );
...
//	desc.setRenderThreadSafety( OFX::eRenderFullySafe );
	...
	//Overlay class
	desc.setOverlayInteractDescriptor( new OFX::DefaultEffectOverlayWrap<ColorCubeViewerOverlayDescriptor>() );
}
 ...
 */
void ColorCubeViewerPluginFactory::describeInContext( OFX::ImageEffectDescriptor& desc,
 ...
 */
OFX::ImageEffect* ColorCubeViewerPluginFactory::createInstance( OfxImageEffectHandle handle,
                                                            OFX::EContext context )
{
