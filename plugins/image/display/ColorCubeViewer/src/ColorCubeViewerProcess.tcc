...
template <class View>
ColorCubeViewerProcess<View>::ColorCubeViewerProcess(ColorCubeViewerPlugin& effect)
 ...
 */
template <class View>
void ColorCubeViewerProcess<View>::multiThreadProcessImages(const OfxRectI& procWindowRoW)
{
