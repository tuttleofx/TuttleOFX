...
void AVWriterPlugin::setParameters( const EAVParamType& type, void* av_class, int req_flags, int rej_flags )
{
	std::vector<OFX::GroupParam*> groups;
...
void AVWriterPlugin::setParameters( const EAVParamType& type, const std::vector<AVPrivOption>& avPrivOpts, const std::string& codec )
{
	std::vector<OFX::GroupParam*> groups;
...
void AVWriterPlugin::setParameters( const PresetParameters& parameters )
{
