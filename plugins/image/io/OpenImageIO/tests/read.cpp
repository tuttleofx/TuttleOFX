...
BOOST_AUTO_TEST_SUITE( plugin_OIIO_reader )
...
{
	TUTTLE_COUT( "******** PROCESS READER OIIO ********" );
	Graph g;

	TUTTLE_COUT( "--> PLUGINS CREATION" );
	Graph::Node& read = g.createNode( "tuttle.oiioreader" );
...
{
	TUTTLE_COUT( "******** PROCESS READER OIIO NO FILE ********" );
	Graph g;
