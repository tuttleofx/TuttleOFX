...
void DPXWriterProcess<View>::multiThreadProcessImages( const OfxRectI& procWindowRoW )
{
	...
	try
	{
		switch( params._bitDepth )
		{
			...
			default:
				BOOST_THROW_EXCEPTION( exception::Unsupported()
							<< exception::message( "DPX Writer: Unsupported bitdepth..." ) );
		}
	}
