...
{
    desc.setLabels("TuttleTurboJpegWriter", "TurboJpegWriter", "Turbo Jpeg file writer");
 ...
 */
void TurboJpegWriterPluginFactory::describeInContext(OFX::ImageEffectDescriptor& desc, OFX::EContext context)
{
 ...
 */
OFX::ImageEffect* TurboJpegWriterPluginFactory::createInstance(OfxImageEffectHandle handle, OFX::EContext context)
{
