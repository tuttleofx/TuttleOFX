...
void TurboJpegWriterProcess<View>::writeImage( View& src )
{
	...
	{
		case eTurboJpegOptimizationNone: flags = 0; break;
		case eTurboJpegOptimizationSSE3: flags |= TJ_FORCESSE3;
		case eTurboJpegOptimizationSSE2: flags |= TJ_FORCESSE2;
		case eTurboJpegOptimizationSSE:  flags |= TJ_FORCESSE;
		case eTurboJpegOptimizationMMX:  flags |= TJ_FORCEMMX;
	}

	switch( _params.subsampling )
	{
		case eTurboJpegSubsampling444:  subsampling = TJSAMP_444; break;
		case eTurboJpegSubsampling422:  subsampling = TJSAMP_422; break;
		case eTurboJpegSubsampling420:  subsampling = TJSAMP_420; break;
		case eTurboJpegSubsamplingGray: subsampling = TJSAMP_GRAY; break;
		case eTurboJpegSubsampling440:  subsampling = TJSAMP_440; break;
	}
