...
namespace OFX
{
    namespace Plugin
    {
        ...
        {
            static tuttle::ParamMathPluginFactory<DoubleParam> d("fr.tuttle.parammath.double", 1, 0);
            static tuttle::ParamMathPluginFactory<IntParam> i("fr.tuttle.parammath.int", 1, 0);
            ids.push_back( &d );
            ids.push_back( &i );
        }
    }
