...
#include <tuttle/plugin/interact/RectangleInteract.hpp>
...
, _interactScene( *effect , _infos )
{
	...
	_interactScene.push_back( new interact::RectangleInteract( _infos, _cornerA, _cornerB ), new interact::ActiveFunctor() );
}
