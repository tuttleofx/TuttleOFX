...
static const std::string hintAverage = "Arithmetic mean\n"
...
static const std::string hintKurtosis = "Kurtosis is a descriptor of the shape of a probability distribution.\n"
                                        "Kurtosis is any measure of the 'peakedness' of the probability distribution "
                                        "of a real-valued random variable.\n";

static const std::string hintSkewness = "Skewness is a measure of the asymmetry of the probability distribution of "
...
{
    desc.setLabels("TuttleImageStatistics", "ImageStatistics", "Image statistics");
 ...
 */
void ImageStatisticsPluginFactory::describeInContext(OFX::ImageEffectDescriptor& desc, OFX::EContext context)
{
    ...
    outputNbPixels->setHint("Number of pixels used to compute statistics.\n"
 ...
 */
OFX::ImageEffect* ImageStatisticsPluginFactory::createInstance(OfxImageEffectHandle handle, OFX::EContext context)
{
