 ...
 */
void DebugImageEffectApiPluginFactory::describeInContext(OFX::ImageEffectDescriptor& desc, OFX::EContext context)
{
 ...
 */
OFX::ImageEffect* DebugImageEffectApiPluginFactory::createInstance(OfxImageEffectHandle handle, OFX::EContext context)
{
