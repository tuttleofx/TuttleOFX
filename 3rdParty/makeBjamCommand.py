...
if linux :
	...
	if os.path.exists(fileExec)==False :
		f = open(fileExec, "w")
		f.write("export BOOST_BUILD_PATH=`pwd`/3rdParty/boost/tools/build/v2\n" )
		f.write("export BOOST_PATH=`pwd`/3rdParty/boost/\n" )
		f.write("export BOOST_ROOT=`pwd`/3rdParty/boost/boost/\n" )
