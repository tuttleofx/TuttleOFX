...
allLibs = [
		...
		('boost',       'http://prdownloads.sourceforge.net/boost/boost_1_55_0.tar.bz2'                                             , '', False), #if not windows else ('boost'   , 'http://sourceforge.net/projects/boost/files/boost/1.54.0/boost_1_54_0.zip'                   , '', False),
		...
		('libraw',      'http://www.libraw.org/data/LibRaw-0.15.4.tar.gz'                                                           , '', False), #if not windows else ('libraw'  , 'http://www.libraw.org/data/LibRaw-0.13.5.zip'                                                , '', False),
