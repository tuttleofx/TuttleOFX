...
allLibs = [
		...
		('boost',       'http://prdownloads.sourceforge.net/boost/boost_1_52_0.tar.bz2'                                             , '', False), #if not windows else ('boost'   , 'http://sourceforge.net/projects/boost/files/boost/1.52.0/boost_1_52_0.zip'                   , '', False),
		('boost_atomic', 'http://www.chaoticmind.net/~hcb/projects/boost.atomic/boost.atomic.tar.gz'                                , '', False),
