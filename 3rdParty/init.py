...
allLibs = [
		...
		('boost',       'http://prdownloads.sourceforge.net/boost/boost_1_49_0.tar.bz2'                                             , '', False), #if not windows else ('boost'   , 'http://sourceforge.net/projects/boost/files/boost/1.47.0/boost_1_47_0.zip'                   , '', False),
