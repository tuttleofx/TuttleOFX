...
allLibs = [
		...
		('boost',       'http://prdownloads.sourceforge.net/boost/boost_1_54_0.tar.bz2'                                             , '', False), #if not windows else ('boost'   , 'http://sourceforge.net/projects/boost/files/boost/1.54.0/boost_1_54_0.zip'                   , '', False),
