...
allLibs = [
		...
		('boost',       'http://prdownloads.sourceforge.net/boost/boost_1_49_0.tar.bz2'                                             , 'boost_1_49_0'                   , False), #if not windows else ('boost'   , 'http://sourceforge.net/projects/boost/files/boost/1.47.0/boost_1_47_0.zip'                   , '', False),
		...
		('openimageio', 'https://github.com/OpenImageIO/oiio/tarball/RB-1.0/OpenImageIO-oiio-Release-1.0.0-0-g5b37f1c.tar.gz'       , 'OpenImageIO-oiio-388f38b'       , False),
		...
		('imagemagick', 'http://www.imagemagick.org/download/ImageMagick.tar.gz'                                                    , 'ImageMagick-6.7.6-5'           , False),
