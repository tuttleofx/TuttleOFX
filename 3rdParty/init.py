...
allLibs = [
		...
		('libpng',      'http://prdownloads.sourceforge.net/libpng/libpng-1.2.41.tar.gz'                                            , '', False),
		...
		('boost',       'http://prdownloads.sourceforge.net/boost/boost_1_55_0.tar.bz2'                                             , '', False),
		('freetype',    'http://prdownloads.sourceforge.net/freetype/freetype-2.4.3.tar.gz'                                         , '', False),
		('libraw',      'http://www.libraw.org/data/LibRaw-0.15.4.tar.gz'                                                           , '', False),
		('libcaca',     'http://caca.zoy.org/files/libcaca/libcaca-0.99.beta17.tar.gz'                                              , '', False),
		('lcms2',       'http://downloads.sourceforge.net/project/lcms/lcms/2.1/lcms2-2.1.tar.gz'                                   , '', False),
		('bzlib',       'http://www.bzip.org/1.0.6/bzip2-1.0.6.tar.gz'                                                              , 'bzip2-1.0.6', False),
		('libtiff',     'ftp://ftp.remotesensing.org/pub/libtiff/tiff-3.9.5.tar.gz'                                                 , '', False),
		('libtool',     'ftp://ftp.gnu.org/gnu/libtool/libtool-2.4.tar.gz'                                                          , '', False),
		('libxml',      'ftp://xmlsoft.org/libxml2/libxml2-2.7.8.tar.gz'                                                            , '', False),
		...
		('jpeg',        'http://freefr.dl.sourceforge.net/project/libjpeg/libjpeg/6b/jpegsrc.v6b.tar.gz'                            , '', False),
