...
allLibs = [
		...
		('boost',       'http://prdownloads.sourceforge.net/boost/boost_1_53_0.tar.bz2'                                             , '', False), #if not windows else ('boost'   , 'http://sourceforge.net/projects/boost/files/boost/1.53.0/boost_1_53_0.zip'                   , '', False),
