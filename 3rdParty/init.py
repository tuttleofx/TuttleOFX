...
allLibs = [
		...
		('opencolorio', 'http://github.com/imageworks/OpenColorIO/tarball/v1.0.6/imageworks-OpenColorIO-v1.0.6-0-g0f89532.tar.gz'   , 'imageworks-OpenColorIO-a16d9ac' , False),
