    ...
    def do_build(self, arg):
        ...
        for lib in libs:
            ...
            if not lib.get('build_cmd'):
                ...
                continue
            if tool.execute_command(lib, 'build_cmd', self.extracted, verbose_output):
                print "Ok - Built."
            else:
    ...
    def do_install(self, arg):
        ...
        for lib in libs:
            ...
            if not lib.get('install_cmd'):
                ...
                continue
            if tool.execute_command(lib, 'install_cmd', self.extracted, verbose_output):
                print "Ok - Installed."
            else:
    ...
    def do_clean(self, arg):
        ...
        for lib in libs:
            ...
            if not lib.get('clean_cmd'):
                ...
                continue
            if tool.execute_command(lib, 'clean_cmd', self.extracted, verbose_output):
                print "Ok - Cleaned."
            else:
