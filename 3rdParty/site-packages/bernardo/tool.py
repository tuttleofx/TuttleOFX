...
def format_lib_as_script(lib):
    ...
    '''
    import all_libs
    destination_dir = all_libs.location()
    template_filename = os.path.join(destination_dir, '_template.py')
    ...
    return template.format(lib_name          = lib.get('name', ''),
                           lib_url           = lib.get('url', ''),
                           lib_sha           = lib.get('sha', ''),
                           lib_configure_cmd = lib.get('configure_cmd', ''),
                           lib_build_cmd     = lib.get('build_cmd', ''),
                           lib_install_cmd   = lib.get('install_cmd', ''),
                           lib_clean_cmd     = lib.get('clean_cmd', ''),
                           lib_distclean_cmd = lib.get('dist_clean_cmd', ''),
                           lib_file_patches  = lib.get('file_patches', ''),
                           # Restoring values that shouldn't be formatted now.
                           name='{name}', url='{url}', sha='{sha}',
