...
BOOST_AUTO_TEST_CASE(graph_NodeInit)
{
    ...
    BOOST_CHECK(compute(list_of(NodeInit("tuttle.pngreader")
                                    .setParam("filename", "TuttleOFX-data/image/png/color-chart.png")
                                    .setParamExp("bitDepth", "32f"))(
        NodeInit("tuttle.pngwriter").setParam("filename", ".tests/graph/output.png"))));
...
BOOST_AUTO_TEST_CASE(graph_unconnect)
{
    ...
    Graph g;
    g.addConnectedNodes(list_of(NodeInit("tuttle.pngreader")
                                    .setParam("filename", "TuttleOFX-data/image/png/color-chart.png")
                                    .setParamExp("bitDepth", "32f"))(NodeInit("tuttle.invert"))(NodeInit("tuttle.invert"))(
        NodeInit("tuttle.invert"))(NodeInit("tuttle.pngwriter").setParam("filename", ".tests/graph/output.png")));
