...
boost::filesystem::path applicationFilepath(const std::string& argv0,
                                            const boost::filesystem::path& currentPath = boost::filesystem::current_path());

inline boost::filesystem::path
canonicalApplicationFilepath(const std::string& argv0,
                             const boost::filesystem::path& currentPath = boost::filesystem::current_path())
{
...
inline boost::filesystem::path
applicationFolder(const std::string& argv0, const boost::filesystem::path& currentPath = boost::filesystem::current_path())
{
    return applicationFilepath(argv0, currentPath).parent_path();
}

inline boost::filesystem::path
canonicalApplicationFolder(const std::string& argv0,
                           const boost::filesystem::path& currentPath = boost::filesystem::current_path())
{
