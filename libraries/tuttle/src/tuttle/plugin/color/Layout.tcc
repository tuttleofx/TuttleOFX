...
template < typename SrcP, typename DstP >
bool convertFromLabLayout( const SrcP& src, DstP& dst )
{
	//std::cout << "Generique conversion"<< std::endl;
	return false;
}
...
template < >
bool convertFromLabLayout( const rgb8_pixel_t& src, rgb8_pixel_t& dst )
{
	convertLabToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromLabLayout( const rgba8_pixel_t& src, rgba8_pixel_t& dst )
{
...
template < >
bool convertFromLabLayout( const rgb16_pixel_t& src, rgb16_pixel_t& dst )
{
	convertLabToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromLabLayout( const rgba16_pixel_t& src, rgba16_pixel_t& dst )
{
	convertLabaToRgba( src, dst );
	return true;
}
...
template < >
bool convertFromLabLayout( const rgb32_pixel_t& src, rgb32_pixel_t& dst )
{
	convertLabToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromLabLayout( const rgba32_pixel_t& src, rgba32_pixel_t& dst )
{
	convertLabaToRgba( src, dst );
	return true;
}
...
template < >
bool convertFromLabLayout( const rgb32f_pixel_t& src, rgb32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertLabToRgb( src, dst );
	return true;
...
template < >
bool convertFromLabLayout( const rgba32f_pixel_t& src, rgba32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertLabaToRgba( src, dst );
	return true;
...
template < typename SrcP, typename DstP >
bool convertToLabLayout( const SrcP& src, DstP& dst )
{
	//std::cout << "Generique conversion"<< std::endl;
	return false;
}
...
template < >
bool convertToLabLayout( const rgb8_pixel_t& src, rgb8_pixel_t& dst )
{
	convertRgbToLab( src, dst );
	return true;
}
...
template < >
bool convertToLabLayout( const rgba8_pixel_t& src, rgba8_pixel_t& dst )
{
...
template < >
bool convertToLabLayout( const rgb16_pixel_t& src, rgb16_pixel_t& dst )
{
	convertRgbToLab( src, dst );
	return true;
}
...
template < >
bool convertToLabLayout( const rgba16_pixel_t& src, rgba16_pixel_t& dst )
{
	convertRgbaToLaba( src, dst );
	return true;
}
...
template < >
bool convertToLabLayout( const rgb32_pixel_t& src, rgb32_pixel_t& dst )
{
	convertRgbToLab( src, dst );
	return true;
}
...
template < >
bool convertToLabLayout( const rgba32_pixel_t& src, rgba32_pixel_t& dst )
{
	convertRgbaToLaba( src, dst );
	return true;
}
...
template < >
bool convertToLabLayout( const rgb32f_pixel_t& src, rgb32f_pixel_t& dst )
{
	convertRgbToLab( src, dst );
	return true;
}
...
template < >
bool convertToLabLayout( const rgba32f_pixel_t& src, rgba32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertRgbaToLaba( src, dst );
	return true;
...
template < typename SrcP, typename DstP >
bool convertFromLuvLayout( const SrcP& src, DstP& dst )
{
	//std::cout << "Generique conversion"<< std::endl;
	return false;
}
...
template < >
bool convertFromLuvLayout( const rgb8_pixel_t& src, rgb8_pixel_t& dst )
{
	convertLuvToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromLuvLayout( const rgba8_pixel_t& src, rgba8_pixel_t& dst )
{
...
template < >
bool convertFromLuvLayout( const rgb16_pixel_t& src, rgb16_pixel_t& dst )
{
	convertLuvToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromLuvLayout( const rgba16_pixel_t& src, rgba16_pixel_t& dst )
{
	convertLuvaToRgba( src, dst );
	return true;
}
...
template < >
bool convertFromLuvLayout( const rgb32_pixel_t& src, rgb32_pixel_t& dst )
{
	convertLuvToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromLuvLayout( const rgba32_pixel_t& src, rgba32_pixel_t& dst )
{
	convertLuvaToRgba( src, dst );
	return true;
}
...
template < >
bool convertFromLuvLayout( const rgb32f_pixel_t& src, rgb32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertLuvToRgb( src, dst );
	return true;
...
template < >
bool convertFromLuvLayout( const rgba32f_pixel_t& src, rgba32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertLuvaToRgba( src, dst );
	return true;
...
template < typename SrcP, typename DstP >
bool convertToLuvLayout( const SrcP& src, DstP& dst )
{
	//std::cout << "Generique conversion"<< std::endl;
	return false;
}
...
template < >
bool convertToLuvLayout( const rgb8_pixel_t& src, rgb8_pixel_t& dst )
{
	convertRgbToLuv( src, dst );
	return true;
}
...
template < >
bool convertToLuvLayout( const rgba8_pixel_t& src, rgba8_pixel_t& dst )
{
...
template < >
bool convertToLuvLayout( const rgb16_pixel_t& src, rgb16_pixel_t& dst )
{
	convertRgbToLuv( src, dst );
	return true;
}
...
template < >
bool convertToLuvLayout( const rgba16_pixel_t& src, rgba16_pixel_t& dst )
{
	convertRgbaToLuva( src, dst );
	return true;
}
...
template < >
bool convertToLuvLayout( const rgb32_pixel_t& src, rgb32_pixel_t& dst )
{
	convertRgbToLuv( src, dst );
	return true;
}
...
template < >
bool convertToLuvLayout( const rgba32_pixel_t& src, rgba32_pixel_t& dst )
{
	convertRgbaToLuva( src, dst );
	return true;
}
...
template < >
bool convertToLuvLayout( const rgb32f_pixel_t& src, rgb32f_pixel_t& dst )
{
	convertRgbToLuv( src, dst );
	return true;
}
...
template < >
bool convertToLuvLayout( const rgba32f_pixel_t& src, rgba32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertRgbaToLuva( src, dst );
	return true;
...
template < typename SrcP, typename DstP >
bool convertFromXYZLayout( const SrcP& src, DstP& dst )
{
	//std::cout << "Generique conversion"<< std::endl;
	return false;
}
...
template < >
bool convertFromXYZLayout( const rgb8_pixel_t& src, rgb8_pixel_t& dst )
{
	convertXYZToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromXYZLayout( const rgba8_pixel_t& src, rgba8_pixel_t& dst )
{
...
template < >
bool convertFromXYZLayout( const rgb16_pixel_t& src, rgb16_pixel_t& dst )
{
	convertXYZToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromXYZLayout( const rgba16_pixel_t& src, rgba16_pixel_t& dst )
{
	convertXYZaToRgba( src, dst );
	return true;
}
...
template < >
bool convertFromXYZLayout( const rgb32_pixel_t& src, rgb32_pixel_t& dst )
{
	convertXYZToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromXYZLayout( const rgba32_pixel_t& src, rgba32_pixel_t& dst )
{
	convertXYZaToRgba( src, dst );
	return true;
}
...
template < >
bool convertFromXYZLayout( const rgb32f_pixel_t& src, rgb32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertXYZToRgb( src, dst );
	return true;
...
template < >
bool convertFromXYZLayout( const rgba32f_pixel_t& src, rgba32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertXYZaToRgba( src, dst );
	return true;
...
template < typename SrcP, typename DstP >
bool convertToXYZLayout( const SrcP& src, DstP& dst )
{
	//std::cout << "Generique conversion"<< std::endl;
	return false;
}
...
template < >
bool convertToXYZLayout( const rgb8_pixel_t& src, rgb8_pixel_t& dst )
{
	convertRgbToXYZ( src, dst );
	return true;
}
...
template < >
bool convertToXYZLayout( const rgba8_pixel_t& src, rgba8_pixel_t& dst )
{
...
template < >
bool convertToXYZLayout( const rgb16_pixel_t& src, rgb16_pixel_t& dst )
{
	convertRgbToXYZ( src, dst );
	return true;
}
...
template < >
bool convertToXYZLayout( const rgba16_pixel_t& src, rgba16_pixel_t& dst )
{
	convertRgbaToXYZa( src, dst );
	return true;
}
...
template < >
bool convertToXYZLayout( const rgb32_pixel_t& src, rgb32_pixel_t& dst )
{
	convertRgbToXYZ( src, dst );
	return true;
}
...
template < >
bool convertToXYZLayout( const rgba32_pixel_t& src, rgba32_pixel_t& dst )
{
	convertRgbaToXYZa( src, dst );
	return true;
}
...
template < >
bool convertToXYZLayout( const rgb32f_pixel_t& src, rgb32f_pixel_t& dst )
{
	convertRgbToXYZ( src, dst );
	return true;
}
...
template < >
bool convertToXYZLayout( const rgba32f_pixel_t& src, rgba32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertRgbaToXYZa( src, dst );
	return true;
...
template < typename SrcP, typename DstP >
bool convertFromYxyLayout( const SrcP& src, DstP& dst )
{
	//std::cout << "Generique conversion"<< std::endl;
	return false;
}
...
template < >
bool convertFromYxyLayout( const rgb8_pixel_t& src, rgb8_pixel_t& dst )
{
	convertYxyToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromYxyLayout( const rgba8_pixel_t& src, rgba8_pixel_t& dst )
{
...
template < >
bool convertFromYxyLayout( const rgb16_pixel_t& src, rgb16_pixel_t& dst )
{
	convertYxyToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromYxyLayout( const rgba16_pixel_t& src, rgba16_pixel_t& dst )
{
	convertYxyaToRgba( src, dst );
	return true;
}
...
template < >
bool convertFromYxyLayout( const rgb32_pixel_t& src, rgb32_pixel_t& dst )
{
	convertYxyToRgb( src, dst );
	return true;
}
...
template < >
bool convertFromYxyLayout( const rgba32_pixel_t& src, rgba32_pixel_t& dst )
{
	convertYxyaToRgba( src, dst );
	return true;
}
...
template < >
bool convertFromYxyLayout( const rgb32f_pixel_t& src, rgb32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertYxyToRgb( src, dst );
	return true;
...
template < >
bool convertFromYxyLayout( const rgba32f_pixel_t& src, rgba32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertYxyaToRgba( src, dst );
	return true;
...
template < typename SrcP, typename DstP >
bool convertToYxyLayout( const SrcP& src, DstP& dst )
{
	//std::cout << "Generique conversion"<< std::endl;
	return false;
}
...
template < >
bool convertToYxyLayout( const rgb8_pixel_t& src, rgb8_pixel_t& dst )
{
	convertRgbToYxy( src, dst );
	return true;
}
...
template < >
bool convertToYxyLayout( const rgba8_pixel_t& src, rgba8_pixel_t& dst )
{
...
template < >
bool convertToYxyLayout( const rgb16_pixel_t& src, rgb16_pixel_t& dst )
{
	convertRgbToYxy( src, dst );
	return true;
}
...
template < >
bool convertToYxyLayout( const rgba16_pixel_t& src, rgba16_pixel_t& dst )
{
	convertRgbaToYxya( src, dst );
	return true;
}
...
template < >
bool convertToYxyLayout( const rgb32_pixel_t& src, rgb32_pixel_t& dst )
{
	convertRgbToYxy( src, dst );
	return true;
}
...
template < >
bool convertToYxyLayout( const rgba32_pixel_t& src, rgba32_pixel_t& dst )
{
	convertRgbaToYxya( src, dst );
	return true;
}
...
template < >
bool convertToYxyLayout( const rgb32f_pixel_t& src, rgb32f_pixel_t& dst )
{
	convertRgbToYxy( src, dst );
	return true;
}
...
template < >
bool convertToYxyLayout( const rgba32f_pixel_t& src, rgba32f_pixel_t& dst )
{
	//std::cout << "compute in 32 bits float" << std::endl;
	convertRgbaToYxya( src, dst );
	return true;
