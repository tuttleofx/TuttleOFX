...
{
public:
    ParamRectangleFromCenterSize(const InteractInfos& infos, OFX::Double2DParam* paramCenter, OFX::Double2DParam* paramSize,
                                 const TFrame& frame);
...
template <class TFrame, ECoordinateSystem coord>
ParamRectangleFromCenterSize<TFrame, coord>::ParamRectangleFromCenterSize(const InteractInfos& infos,
...
ParamRectangleFromCenterSize<TFrame, coord>::selectType(const OFX::PenArgs& args) const
{
