...
template <typename View1, typename View2, typename F>
GIL_FORCEINLINE
F transform_pixel_positions_progress( const View1& src, const View2& dst, const F& fun, IProgress& p )
{
	assert( src.dimensions() == dst.dimensions() );
...
template <typename View1, typename View2, typename View3, typename F>
GIL_FORCEINLINE
F transform_pixel_positions_progress( const View1& src1, const View2& src2, const View3& dst, const F& fun, IProgress& p )
{
	assert( src1.dimensions() == dst.dimensions() );
	assert( src2.dimensions() == dst.dimensions() );
