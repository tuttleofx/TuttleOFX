...
struct channel_converter_unsigned<bits16h, DstChannelV>
	: public std::unary_function<bits16h, DstChannelV>
{
	DstChannelV operator()( bits16h h ) const
	{
		return DstChannelV( half( h )
		                    * float(channel_traits<DstChannelV>::max_value() ) + 0.5f );
	}
...
struct channel_converter_unsigned<SrcChannelV, bits16h>
	: public std::unary_function<SrcChannelV, bits16h>
{
...
struct channel_converter_unsigned<bits16h, bits16h>
	: public std::unary_function<bits16h, bits16h>
{
	bits16h operator()( bits16h h ) const
	{
		return h;
	}
...
struct channel_converter_unsigned<bits32f, bits16h>
	: public std::unary_function<bits32f, bits16h>
{
...
struct channel_converter_unsigned<bits16h, bits32f>
	: public std::unary_function<bits16h, bits32f>
{
...
struct channel_multiplier_unsigned<bits16h>
	: public std::binary_function<bits16h, bits16h, bits16h>
{
	bits16h operator()( bits16h a, bits16h b ) const
	{
		return a* b;
	}
