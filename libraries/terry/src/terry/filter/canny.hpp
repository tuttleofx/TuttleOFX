...
void canny(const SView& srcView, const TRGBView& tmpSobelView, const TGrayView& tmpGrayView, const DView& cannyView,
           const point2<double>& sobelSize, const convolve_boundary_option sobelBoundaryOption, const double cannyThresLow,
           const double cannyThresUpper)
{
    ...
    // t.restart();
    boost::gil::transform_pixels(kth_channel_view<0>(tmpSobelView), // srcX
