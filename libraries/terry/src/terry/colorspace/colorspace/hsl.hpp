...
typedef ::boost::mpl::vector3<hsl_colorspace::hue_t, hsl_colorspace::saturation_t, hsl_colorspace::lightness_t>
    hsl_colorspace_t;
...
void color_transformation_step(const HSLParams& params, const boost::gil::pixel<SChannelType, HSL::layout>& src,
...
BOOST_MPL_ASSERT((::boost::mpl::equal< ::boost::mpl::vector<XYZ, RGB>,
                                       ::boost::mpl::at_c<color_dependencies<HSL>::color_steps_from_root, 0>::type>));
BOOST_MPL_ASSERT((::boost::mpl::equal< ::boost::mpl::vector<RGB, HSL>,
