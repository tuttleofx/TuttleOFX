...
typedef boost::mpl::vector4<cmyk_colorspace::cyan_t, cmyk_colorspace::magenta_t, cmyk_colorspace::yellow_t,
...
void color_transformation_step(const CMYKParams& params, const boost::gil::pixel<SChannelType, CMYK::layout>& src,
...
template <typename SChannelType, typename DChannelType>
void color_transformation_step(const CMYKParams& params, const boost::gil::pixel<SChannelType, RGB::layout>& src,
