...
struct test1
{
    void operator()()
    {
        ...
        layer_t a[] = {
            fill_t(rgb8_view_t::value_type(255, 0, 255)), fill_t(rgb8_view_t::value_type(255, 0, 0)),
            fill_t(rgb8_view_t::value_type(0, 0, 255)),   fill_t(rgb8_view_t::value_type(255, 0, 0)),
            fill_t(rgb8_view_t::value_type(100, 0, 255)), fill_t(rgb8_view_t::value_type(100, 0, 100)),
        };
