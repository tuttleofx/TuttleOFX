...
T swapEndian( T _var )
{
	...
	switch( sizeof( T ) )
	{
		...
		case 8: swapped[0] = *( (unsigned char*)addr + 7 );
			...
			break;
		case 16: swapped[0] = *( (unsigned char*)addr + 15 );
